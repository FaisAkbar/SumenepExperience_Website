...
<head>
    ...
    <link href="assets/images/favicon1.ico" type="img/x-icon" rel="shortcut icon">
...
include "connect.php";
    ...
    $id = $_GET['kd_wisata'];
    $query_mysql = mysqli_query($con, "SELECT * FROM wisata WHERE kd_wisata = '$id'");
                    ...
                    <div class="col">
                        ...
                        <div class="page-banner text-left">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li style="color: white; font-weight: bold;">Edit Data</li>
                            </ul>
                        </div>
    ...
    <div
        class="my-account-section section pt-5  pb-100 pb-5">
        <div class="container">
            <div class="row">
                                ...
                                <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                                    <div class="myaccount-content">
                                        ...
                                        <div class="welcome mb-20">
                                            <form action="edit_wisata_fct.php" method="POST">
                                                <table>
                                                    <tr>
                                                        <td>Kode wisata</td>
                                                        <td><input type="text" name="kd_wisata"
                                                        value="<?php echo $data['kd_wisata'] ?>" readonly></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Nama wisata</td>
                                                    ...
                                                    <tr>
                                                        <td>Foto wisata (.jpg)</td>
                                                        <td><input type="file" name="gambar" value="<?php echo $data['gambar'] ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Foto Besar wisata (.jpg) </td>
                                                        <td><input type="file" name="gambar_L" value="<?php echo $data['gambar_L'] ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Harga Tiket (Rp. )</td>
                                                        <td><input type="text" name="harga_wisata" value="<?php echo $data['harga_tiket'] ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Deskripsi wisata </td>
                                                        <td><textarea name="deskripsi_wisata" rows="5"
                                                                cols="40"><?php echo $data['deskripsi_wisata'] ?></textarea></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Open - Closes </td>
                                                        <td><input type="text" name="open_closes" value="<?php echo $data['open_closes'] ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Alamat wisata</td>
                                                        <td><input type="text" name="gmaps" value="<?php echo $data['gmaps'] ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                        <td><button type="submit" value="Simpan" class="btn btn-success">Simpan</td>
                                                    </tr>
                                                </table>
                                            </form>
                                        </div>
